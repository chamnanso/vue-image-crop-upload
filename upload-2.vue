  ...
  <div class="vue-image-crop-upload" v-show="value">
    <div class="vicp-wrap">
      ...
      <div class="vicp-step1" v-show="step == 1">
        ...
        <slot v-if="$slots['step1-footer']" name="step1-footer"></slot>
        <div v-else class="vicp-operate">
          <a @click="off" @mousedown="ripple">{{ lang.btn.off }}</a>
        </div>
      </div>

      <div class="vicp-step2" v-if="step == 2">
        <slot name="step2-header"></slot>
        <div class="vicp-crop">
          ...
          <div class="vicp-crop-right" v-show="!noSquare || !noCircle">
        ...
        <slot v-if="$slots['step1-footer']" name="step2-footer"></slot>
        <div v-else class="vicp-operate">
